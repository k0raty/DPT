...
class frame():
    ...
    def __init__(self):
        ...
        self.continue_button = tk.Button(
            self.app, text="Continue", command=self.show_next_window)

        self.quit_button = tk.Button(self.app, text="Quit", command=self.fQuit)

        self.radio_widget_meth1 = tk.Radiobutton(
            self.method_frame, text="Méthode 1", value=0, variable=self.varMeth)
        self.radio_widget_meth2 = tk.Radiobutton(
            self.method_frame, text="Méthode 2", value=1, variable=self.varMeth)
        self.radio_widget_meth3 = tk.Radiobutton(
            self.method_frame, text="Méthode 3", value=2, variable=self.varMeth)
    ...
    def bar(self):
        ...
        for acquisition in range(self.varNbreAcquis.get()):
            ...
            labelAcq = tk.Label(
                self.next_window, text="Acquisition " + str(acquisition+1))
            labelAcq.pack()
        """
    ...
    def methode1(self):
        ...
        tk.Button(self.next_window, text='Start',
        ...
        continue_button = tk.Button(
            self.next_window, text="Analyser", command=self.analyse)
        continue_button.pack()
        """
        continue2_button = tk.Button(
            self.next_window, text="Continue", command=self.suite_analyse)
